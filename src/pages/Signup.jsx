        ...
        <div className="login1">
          ...
          <div className="login-1">
            <div className="login-11">
              <h5>Welcome to Meghanix Homex </h5>
              <p>Today is a new day. It's your day. You shape it.
                Sign in to start managing your projects.</p>
            </div>
            <div className="login-21">
              <label htmlFor="phone">Phone Number</label><br />
              <input type="text" id="phone" placeholder="+91 92798 12345" /><br /><br />
              <label htmlFor="mail">Email</label><br />
              <input type="mailto" id="mail" placeholder="Example@email.com" /><br />
              <label htmlFor="password">Password</label><br />
              <input type="text" id="password" placeholder="at least 8 character" /><br />
            ...
            <p className="login-4">Already have an account?<span>Log in</span> </p>
          </div>
